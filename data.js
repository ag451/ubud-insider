...
const UBUD_DATA = {
    ...
    places: [
        ...
        { id: 5, name: "Cafe Curendera", category: "breakfast", vibes: ["calm", "nature", "local"], description: "Hidden veggie lunch spot in jungle", area: "North Ubud", lat: -8.5200, lng: 115.2800 },
        ...
        { id: 7, name: "Jungle Fish", category: "breakfast", vibes: ["nature", "aesthetic", "social"], description: "Beautiful jungle pool, go for lunch with pool pass on sunny day", area: "North Ubud", lat: -8.5205, lng: 115.2810 },
        { id: 8, name: "Tis Cafe", category: "breakfast", vibes: ["nature", "aesthetic", "calm"], description: "Beautiful views of rice terraces and pool", area: "North Ubud", lat: -8.4300, lng: 115.2800 },
        ...
        { id: 10, name: "Pukako", category: "breakfast", vibes: ["nature", "aesthetic", "calm"], description: "Beautiful cafe on rice fields", area: "Penestanan", lat: -8.5150, lng: 115.2650 },
        ...
        { id: 12, name: "Roosters", category: "breakfast", vibes: ["social", "lively"], description: "Big out of town brekkie/lunch spot", area: "North Ubud", lat: -8.5500, lng: 115.2500 },
        ...
        { id: 33, name: "Warung Shanti", category: "warung", vibes: ["local", "nature", "calm"], description: "Indonesian, great views", area: "Penestanan", lat: -8.5160, lng: 115.2660 },
        ...
        { id: 38, name: "Nari", category: "finedining", vibes: ["luxury", "romantic", "nature"], description: "Wood-fire bistro overlooking Campuhan Ridge walk", area: "Town Centre", lat: -8.5050, lng: 115.2550 },
        ...
        { id: 46, name: "Little Green Door", category: "drinks", vibes: ["lively", "social"], description: "Best dancing club (Canggu)", area: "Town Centre", lat: -8.6500, lng: 115.1500 },
        ...
        // Yoga & Spiritual
        { id: 48, name: "Pyramids of Chi", category: "yoga", vibes: ["spiritual", "calm"], description: "Ancient Sound Healing, Inner Child with Nicole", area: "North Ubud", lat: -8.5500, lng: 115.2800 },
        ...
        { id: 52, name: "Ubud Yoga House", category: "yoga", vibes: ["spiritual", "calm", "nature"], description: "Small classes, incredible views of ricefields", area: "Penestanan", lat: -8.5160, lng: 115.2670 },
        ...
        { id: 59, name: "Qi - western medicine & TCM doctor", category: "healers", vibes: ["spiritual", "calm", "nature"], description: "Book for acupuncture or cupping, beautiful clinic in the jungle", area: "North Ubud", lat: -8.5210, lng: 115.2820 },
        ...
        { id: 63, name: "Tjampuan Spa", category: "spa", vibes: ["calm", "nature", "luxury"], description: "Outdoor hot pools / sauna etc", area: "Sayan", lat: -8.5100, lng: 115.2700 },
        ...
        { id: 65, name: "Jaens Spa / Karsa / Hesa", category: "spa", vibes: ["calm", "nature", "aesthetic"], description: "Beautiful spas with great masseuses", area: "Town Centre", lat: -8.5150, lng: 115.2700 },
        ...
        { id: 68, name: "Dragon Fly Village", category: "spa", vibes: ["spiritual", "calm", "nature"], description: "Outdoor herbal sauna, bonfire and Salt Water Pool. Mon/Weds/Sat 6-9pm", area: "Penestanan", lat: -8.5085, lng: 115.2585 },

        // Walks
        { id: 69, name: "Sok Subak Wah Walk", category: "walks", vibes: ["nature", "calm", "romantic"], description: "Beautiful peaceful sunset walk in rice fields", area: "Penestanan", lat: -8.5080, lng: 115.2580 },
        { id: 70, name: "Sweet Orange trail walk", category: "walks", vibes: ["nature", "calm", "local"], description: "Rice field walk, nice Warungs for dinner", area: "Penestanan", lat: -8.5170, lng: 115.2680 },
        { id: 71, name: "Hikaria", category: "walks", vibes: ["aesthetic", "romantic", "spiritual"], description: "Beautiful night walk with sound and light show", area: "North Ubud", lat: -8.5600, lng: 115.2500 },
        { id: 72, name: "Campuhan Ridge Walk", category: "walks", vibes: ["nature", "calm", "aesthetic"], description: "Famous ridge walk with scenic views", area: "Town Centre", lat: -8.5050, lng: 115.2550 },

        // Excursions
        { id: 73, name: "Water Purification Ceremony", category: "excursions", vibes: ["spiritual", "local", "deepwork"], description: "Book on Airbnb with trip to shaman, or go to Tirta Empul or Sebatu. Go early to avoid crowds.", area: "Town Centre", lat: -8.5300, lng: 115.3200 },
        { id: 74, name: "Mount Batur", category: "excursions", vibes: ["nature", "lively", "aesthetic"], description: "Sunrise Volcano Hike", area: "North Ubud", lat: -8.2400, lng: 115.3800 },
        { id: 75, name: "Tegallang Rice Terraces", category: "excursions", vibes: ["nature", "aesthetic", "calm"], description: "Go for walk, lunch at Tis Cafe and swim. Don't need a guide.", area: "North Ubud", lat: -8.4300, lng: 115.2800 },
